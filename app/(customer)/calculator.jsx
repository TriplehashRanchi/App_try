...
export default function InvestmentCalculator() {
  ...
  const FDPLUS_RATE = 0.10;  // 10% monthly for 20 months
  ...
  const chartData = useMemo(() => {
    ...
    if (mode === "fd") {
      ...
      for (let m = 0; m <= maxMonths; m++) {
        const value = principal * (1 + FDPLUS_RATE * m);
        data.push({ timestamp: m, value });
      }
    }
  ...
  const calculate = () => {
    ...
    if (mode === "fdplus") {
      const maturityValue = principal * (1 + FDPLUS_RATE * 20);
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {mode === "fdplus" && (
              <View style={styles.infoBox}>
                <Text style={styles.infoText}>
                  ℹ️ FD Plus has a fixed tenure of 20 months
                </Text>
              </View>
            )}
          </View>
          ...
          <View style={styles.summaryCard}>
            ...
            {mode === "fdplus" && (
              <View style={styles.additionalInfo}>
                <View style={styles.infoRow}>
                  <Text style={styles.infoLabel}>Total Returns</Text>
