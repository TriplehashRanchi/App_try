...
import { useAuth } from "../../../../context/AuthContext";
  ...
  export default function InvestmentDetails() {
        ...
        return {
          ...
          nextPayout:
            investment.payoutHistory?.length > 0
              ? formatDate(addMonths(investment.payoutHistory.slice(-1)[0].payoutDate, 1))
              : formatDate(addMonths(investment.activationDate, 1)),
        };
      }

      if (investment.type === "fd_plus") {
        const monthly = p * 0.10;
    ...
    const currentValue = investment.analytics?.currentValue || investment.principalAmount;
    const totalGain = investment.analytics?.totalGain || 0;
    const gainPercentage = ((totalGain / investment.principalAmount) * 100).toFixed(2);
